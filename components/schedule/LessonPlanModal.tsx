  ...
  const handleManualSave = async (finalize = false) => {
    ...
    try {
      ...
      if (existingPlan) {
        ...
        const response = await fetch(`/api/lessons/${existingPlan.lesson_plan_id}`, {
          method: "PUT",
          ...
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-2xl font-bold text-gray-900">
                {isViewMode ? "Lesson Plan" : existingPlan ? "Edit Lesson Plan" : "Create Lesson Plan"}
              </h2>
              <p className="text-sm text-gray-600 mt-1">
                {student.name} • {session.date} • {session.time} ({session.duration} min)
              </p>
            </div>
            <button
              onClick={onClose}
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      onChange={(e) =>
                        setManualForm({ ...manualForm, teaching_notes: e.target.value })
                      }
                      rows={12}
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        setManualForm({ ...manualForm, worksheet_id: e.target.value })
                      }
                  ...
                  <div className="flex gap-3 pt-4">
                    ...
                    >
                      {loading ? "Saving..." : existingPlan ? "Update" : "Save Draft"}
                    </button>
                    {!existingPlan && (
                      <button
